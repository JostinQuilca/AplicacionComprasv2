...
const getBadgeClassName = (estado: FacturaCompra['estado']) => {
    switch (estado) {
        case 'Impresa': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-300';
        case 'Registrada': return 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300';
